...
一款专门为中文用户打造的小工具，从此告别在桌面上按键盘出现的输入框。
...
它破坏美感、打断思路，而且系统设置里根本没有关闭它的开关。

这个问题我看了网上相关吐槽特别多，应该是一个陈年老 bug，好像 Monterey 就出现了。而 Apple 始终没有给出解决办法。所以，我请 DeepSeek 来解决了这个问题
