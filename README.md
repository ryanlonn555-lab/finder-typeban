...
一款专门为中文用户打造的小工具，从此告别桌面上按键盘出现的输入框。

---

## 问题的情况

macOS 26 开始，访达多了一个「快速搜索」功能：只要你在桌面或某个窗口里**没选中任何文件**时按下键盘，访达就会一边打字一边帮你过滤文件名。

这本来是个挺贴心的设计，**直到你用的是中文输入法。**

当你开着简体拼音、在桌面、访达里面打字，就会出现一个输入框，这让人强迫症发狂：

![访达快速搜索输入框](images/finder-input-box.png)

它破坏美感、打断思路，而且，

> **系统设置里根本没有关闭它的开关。**

这个问题我看了网上相关吐槽一抓一大把，应该是一个陈年老bug，好像 Monterey 就出现了。而 Apple 始终没有给出解决办法。所以，我用DeepSeek解决了这个问题
